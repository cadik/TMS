...
TMOSong14::TMOSong14()
{
	...
	SetDescription(L"Color to grayscale operator for images and video, method from paper Real-time video decolorization using bilateral filtering"); // TODO - Insert description
}
