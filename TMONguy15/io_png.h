...
#include <stddef.h>
    ...
    double *io_png_read_f32(const char *fname, size_t *nxp, size_t *nyp, size_t *ncp);
    ...
    int io_png_write_f32(const char *fname, const double *data, size_t nx, size_t ny, size_t nc);
