...
public:
   ...
   */
  cv::Mat applyTwoStageModel(double ***newLMSSens, std::vector<double> spd,
                             double I, std::vector<double> params);
   ...
   */
  std::vector<double> RGBtoSpectrum(double ***newColorData, double red,
  ...
  // bin width
  const static int binWidth =
      5; // range 390nm to 750nm divided into 72 bins => bin width = 5nm
  // number of colors
  ...
  // 72 bins of 7 colors on range 390nm to 750nm for Smits 1999 RGB to Spectrum
  // conversion generated by the matlab code from
  ...
  double LMSsensitivities[bins][3] = {{4.07619E-04, 3.58227E-04, 6.14265E-03},
