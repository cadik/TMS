...
const char descriptor_table_protodef_versions_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "(\005\022\025\n\rbad_consumers\030\003 \003(\005B\200\001\n\030org.tensor"
  "flow.frameworkB\016VersionsProtosP\001ZOgithub"
  ".com/tensorflow/tensorflow/tensorflow/go"
  "/core/framework/versions_go_proto\370\001\001b\006pr"
  "oto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_versions_2eproto = {
  &descriptor_table_versions_2eproto_initialized, descriptor_table_protodef_versions_2eproto, "versions.proto", 244,
