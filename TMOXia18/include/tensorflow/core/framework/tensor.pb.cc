...
static void InitDefaultsscc_info_TensorProto_tensor_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_TensorProto_tensor_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, InitDefaultsscc_info_TensorProto_tensor_2eproto}, {
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_tensor_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_tensor_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "s\030\003 \003(\0132\027.tensorflow.TensorProtoB|\n\030org."
  "tensorflow.frameworkB\014TensorProtosP\001ZMgi"
  "thub.com/tensorflow/tensorflow/tensorflo"
  "w/go/core/framework/tensor_go_proto\370\001\001b\006"
  "proto3"
  ;
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_tensor_2eproto_sccs[1] = {
...
static bool descriptor_table_tensor_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_tensor_2eproto = {
  &descriptor_table_tensor_2eproto_initialized, descriptor_table_protodef_tensor_2eproto, "tensor.proto", 926,
  &descriptor_table_tensor_2eproto_once, descriptor_table_tensor_2eproto_sccs, descriptor_table_tensor_2eproto_deps, 1, 3,
...
static bool dynamic_init_dummy_tensor_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_tensor_2eproto), true);
namespace tensorflow {
...
void TensorProto::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_TensorProto_tensor_2eproto.base);
  tensor_content_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
