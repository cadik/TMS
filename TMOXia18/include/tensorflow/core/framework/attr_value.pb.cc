...
const char descriptor_table_protodef_attr_5fvalue_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "low.AttrValue:\0028\001B\203\001\n\030org.tensorflow.fra"
  "meworkB\017AttrValueProtosP\001ZQgithub.com/te"
  "nsorflow/tensorflow/tensorflow/go/core/f"
  "ramework/attr_value_go_proto\370\001\001b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_attr_5fvalue_2eproto = {
  &descriptor_table_attr_5fvalue_2eproto_initialized, descriptor_table_protodef_attr_5fvalue_2eproto, "attr_value.proto", 999,
...
void AttrValue::SerializeWithCachedSizes(
  ...
  if (has_shape()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteMessageMaybeToArray(
      7, _Internal::shape(this), output);
  }

  // .tensorflow.TensorProto tensor = 8;
  if (has_tensor()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteMessageMaybeToArray(
      8, _Internal::tensor(this), output);
  }
...
::PROTOBUF_NAMESPACE_ID::uint8* AttrValue::InternalSerializeWithCachedSizesToArray(
  ...
  if (has_tensor()) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(
        8, _Internal::tensor(this), target);
  }
  ...
  if (!this->attr().empty()) {
    ...
    if (output->IsSerializationDeterministic() &&
      ...
      for (size_type i = 0; i < n; i++) {
        NameAttrList_AttrEntry_DoNotUse::Funcs::SerializeToCodedStream(2, items[static_cast<ptrdiff_t>(i)]->first, items[static_cast<ptrdiff_t>(i)]->second, output);
      ...
      for (::PROTOBUF_NAMESPACE_ID::Map< std::string, ::tensorflow::AttrValue >::const_iterator
          it = this->attr().begin();
          it != this->attr().end(); ++it) {
        NameAttrList_AttrEntry_DoNotUse::Funcs::SerializeToCodedStream(2, it->first, it->second, output);
        Utf8Check::Check(&(*it));
      }
    }
  }
...
::PROTOBUF_NAMESPACE_ID::uint8* NameAttrList::InternalSerializeWithCachedSizesToArray(
  ...
  if (!this->attr().empty()) {
    ...
    if (false &&
      ...
      ::std::sort(&items[0], &items[static_cast<ptrdiff_t>(n)], Less());
      for (size_type i = 0; i < n; i++) {
        target = NameAttrList_AttrEntry_DoNotUse::Funcs::SerializeToArray(2, items[static_cast<ptrdiff_t>(i)]->first, items[static_cast<ptrdiff_t>(i)]->second, target);
        Utf8Check::Check(&(*items[static_cast<ptrdiff_t>(i)]));
      }
    } else {
      for (::PROTOBUF_NAMESPACE_ID::Map< std::string, ::tensorflow::AttrValue >::const_iterator
          it = this->attr().begin();
          it != this->attr().end(); ++it) {
        target = NameAttrList_AttrEntry_DoNotUse::Funcs::SerializeToArray(2, it->first, it->second, target);
        Utf8Check::Check(&(*it));
      }
    }
  }
