...
public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_struct_2eproto);
    return ::descriptor_table_struct_2eproto.file_level_metadata[4];
  }
...
class TypeSpecProto :
 ...
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 num_flat_components() const;
  void set_num_flat_components(::PROTOBUF_NAMESPACE_ID::int32 value);
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 num_flat_components_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_struct_2eproto;
};
// ===================================================================
...
inline ::PROTOBUF_NAMESPACE_ID::int32 TypeSpecProto::num_flat_components() const {
  // @@protoc_insertion_point(field_get:tensorflow.TypeSpecProto.num_flat_components)
  return num_flat_components_;
}
inline void TypeSpecProto::set_num_flat_components(::PROTOBUF_NAMESPACE_ID::int32 value) {
