...
/**
 * @brief functions for setting starting values of variables for AdamClassType
 */
...
/**
 * @brief color conversion from CIELab to RGB
...
/**
 * @brief Decalorization method via order set
 * 
 * @param sourceImageRGB 
 * @param destImageGray 
 * @param Mat_height 
 * @param Mat_width 
 * @param Omega 
...
/**
 * @brief Function that computes Contrast Loss between lab and grayscale
 * We are looking for minimum terurned doutle Adam Gradient Descent solver
 * 
 * @param PixNumberInClusters 
 * @param centersLAB 
 * @param centersRGB 
 * @param centersGray 
 * @param centersSize 
